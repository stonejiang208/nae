...
(setq org-html-home/up-format "<div id=\"org-div-home-and-up\">
 <a accesskey=\"h\" href=\"%s\"> 上一层 </a>
 |
 <a accesskey=\"H\" href=\"%s\"> Blog主页 </a>
</div>")
(setq org-html-preamble-format '(("zh-CN" "%a")))
...
(setq org-html-postamble-format '(("zh-CN" "<p class=\"author\">作者：%a (<script type=\"text/javascript\">document.write(\"<n uers=\\\"znvygb:v@uryyborne.arg\\\">v@uryyborne.arg</n>\".replace(/[a-zA-Z]/g,
